...
def train(epoch, best_val_loss, lambda_A, c_A, optimizer):
    ...
    for batch_idx, (data, relations) in enumerate(train_loader):
        ...
        # compute metrics
        graph = origin_A.data.clone().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().numpy()
...
matG1 = np.matrix(origin_A.data.clone().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().cpu().numpy())
